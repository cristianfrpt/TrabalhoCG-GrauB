...
SimpleObject* ObjectReader::loadSimpleOBJ(string filepath, Shader* shader, glm::vec3 color, glm::vec3 position, glm::vec3 scale) {
	...
	SimpleObject* object = new SimpleObject(shader, vbuffer.size() / 11, VAO, position, scale);
...
SimpleObject* ObjectReader::createSquare(Shader* shader) {
	...
	SimpleObject* object = new SimpleObject(shader, 36, VAO, glm::vec3(-1.0, 0.0, 1.0), glm::vec3(1.0, 1.0, 1.0));
	return object;
}